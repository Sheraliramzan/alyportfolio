    ...
    return(
        <div className="fixed w-full h-20 bg-slate-200 shadow-xl z-[100]">
            <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
                ...
                <div className={show ? "fixed left-0 top-0 w-full h-screen bg-black/60" : ""}>
                    <div className={show ? "left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-slate-300 p-10 ease-in duration-500" : "left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-slate-300 p-10 ease-in duration-500"}>
                        <div>
