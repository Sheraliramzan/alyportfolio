        ...
        <div className="fixed w-full h-20 bg-rose-50 shadow-xl z-[100]">
            <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
                ...
                <div className="fixed left-0 top-0 w-full h-screen bg-black/60">
                    <div className="left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-slate-300-200 p-10 ease-in duration-500">
                        <div>
                            <div className="flex w-full items-center justify-between">
                                ...
                                height={35}
                                />
                                <div className="bg-amber-400 rounded-full shadow-lg shadow-black p-3 cursor-pointer">
